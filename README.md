...
**Beta feature**: if compiled with WITH_TLS_13 flag, TLSe supports TLS 1.3 (draft 28) server-side only (no client yet). It does not implement 0-RTT nor HelloRetryRequest.
